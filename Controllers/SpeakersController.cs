...
namespace Audio_Speaker.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ReleaseDate,Type,Company,Price")] Speaker speaker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ReleaseDate,Type,Company,Price")] Speaker speaker)
        {
            if (id != speaker.Id)
            {
                return NotFound();
